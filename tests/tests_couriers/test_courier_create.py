...
class TestCourierCreate:
    ...
    @pytest.mark.parametrize('empty_credentials', [
        {'login': '', 'password': TestData.generate_random_password(), 'firstName': TestData.generate_random_firstname()},
        {'login': TestData.generate_random_login(), 'password': '', 'firstName': TestData.generate_random_firstname()}
    ])
